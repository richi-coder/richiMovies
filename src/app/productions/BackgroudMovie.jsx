...
function BackgroudMovie() {
  ...
  return (
    ...
    <div
        className='fixed top-0 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0 h-[50vh] aspect-video sm:h-screen sm:w-screen -z-10 duration-500 bg-no-repeat bg-contain bg-center sm:bg-right-top'
