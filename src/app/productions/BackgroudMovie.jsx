...
function BackgroudMovie() {
  ...
  return (
    ...
    <div
        className='fixed top-0 left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 h-[50vh] aspect-video sm:w-full sm:aspect-video sm:h-auto md:h-screen md:w-screen -z-10 duration-500 bg-no-repeat bg-contain bg-center md:bg-right-top'
